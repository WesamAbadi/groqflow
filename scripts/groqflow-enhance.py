...
MODE_PROMPTS = {
    "fix": (
        ...
        "Add structure where it helps readability: "
        "use bullet points for lists, break long text into paragraphs, "
        "add markdown formatting (bold, headings, code) when appropriate. "
